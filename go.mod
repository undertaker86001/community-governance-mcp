module community-governance-mcp

go 1.24.1

require github.com/higress-group/wasm-go v1.0.0
...
replace github.com/higress-group/wasm-go => github.com/higress-group/wasm-go v1.0.0
